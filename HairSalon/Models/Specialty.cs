...
namespace HairSalon.Models
{
    public class Specialty
    {
        ...
        public void UpdateSpecialty(string newSpecialty)
        {
            ...
            conn.Open();
            var cmd = conn.CreateCommand() as MySqlCommand;
            cmd.CommandText = @"UPDATE specialties SET specialty = @newSpecialty WHERE id = @id;";
        ...
        public List<Stylist> GetStylists()
        {
            ...
            MySqlParameter specialtyPara = new MySqlParameter("@specialty_id", _id);
            cmd.Parameters.Add(specialtyPara);
            ...
            foreach (int stylistId in stylistIds)
            {
                ...
                while (rdr2.Read())
                {
                    ...
                    string stylistNumber = rdr2.GetString(2);
                    Stylist foundStylist = new Stylist(stylistName, stylistNumber);
        ...
        public void Delete()
        {
            ...
            conn.Open();
            MySqlCommand cmd = conn.CreateCommand() as MySqlCommand;
            cmd.CommandText = @"DELETE FROM specialties WHERE id=@id; @DELETE FROM specialty_stylist WHERE id=@id;";
